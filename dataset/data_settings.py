...
class MIX:
    ...
    COCO_ROOT_PATH = '/media/xuchengjun/datasets/coco_2017'
    COCO_JSON_PATH = '/media/xuchengjun/datasets/COCO'    # COCO json path
    ...
    # new_CMU_json_file
    CMU_ROOT_PATH = '/media/xuchengjun/datasets/panoptic-toolbox'
    CMU_JSON_PATH = ['/media/xuchengjun/datasets/CMU/train/160422_ultimatum1/00']  #  train or generation
    CMU_VAL_JSON_PATH = '/media/xuchengjun/datasets/CMU/train/160422_ultimatum1/00' # for test
    CMU_TRAIN_IMGS = 13000
    CMU_GENERATION_IMGS = 200000    # refine net train dataset
