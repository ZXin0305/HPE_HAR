    ...
    for idx, batch in enumerate(data):
        ...
        with torch.no_grad():
            ...
            for i in range(len(imgs)):
                ...
                # embed()
                # new_pred_bodys_3d = augment_pose(new_pred_bodys_3d)
                # show_3d_results(new_pred_bodys_3d, cfg.SHOW.BODY_EADGES)
     
                # print(pred_bodys_3d[:,2,2], new_gt_bodys[:,2,2])
...
def main():
    ...
    parser.add_argument("--test_mode", "-t", type=str, default="generate_result",
    ...
    parser.add_argument("--SMAP_path", "-p", type=str, default='/media/xuchengjun/zx/human_pose/pth/main/20220325/train.pth',
    ...
    parser.add_argument("--dataset_path", type=str, default="/media/xuchengjun/datasets/action/images/stand",
